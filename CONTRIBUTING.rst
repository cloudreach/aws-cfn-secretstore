...
Before submitting a bug, please check our `issues page <https://github.com/cloudreach/aws-cfn-secretstore/issues>`_ to see if it's already been reported.
...
1. Fork the ``aws-cfn-secretstore`` repository on GitHub.
2. Clone your fork locally::

    $ git clone git@github.org:your_name_here/aws-cfn-secretstore.git
